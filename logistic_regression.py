...
def do_experiments(start, end, step_num):
    ...
    plt.subplot(3, 3, 1)
    plt.plot(shift_distances, beta0_list, 'o-', label="Beta0")
    ...
    plt.subplot(3, 3, 2)
    plt.plot(shift_distances, beta1_list, 'o-', label="Beta1")
    ...
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, 'o-', label="Beta2")
    ...
    plt.subplot(3, 3, 4)
    plt.plot(shift_distances, slope_list, 'o-', label="Slope (Beta1 / Beta2)")
    ...
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, intercept_list, 'o-', label="Intercept (Beta0 / Beta2)")
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, 'o-', label="Logistic Loss")
    ...
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, 'o-', label="Margin Width")
